...
export const ARCHIVE_BOOK_VOLLEY_KEY = "archive-book-volley";
export const ARCHIVE_BOOK_VOLLEY_FRAME_WIDTH = 128;
export const ARCHIVE_BOOK_VOLLEY_FRAME_HEIGHT = 128;
