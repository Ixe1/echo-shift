...
const sourceLevels: Level[] = [
  ...
  },
  {
    ...
    backgroundKey: "level-2-readable-lab",
    backgroundAmbience: { preset: "data", intensity: 0.38, color: "#bd5cff", drift: 0.46, flicker: 0.28, particles: 0.32 },
    start: { x: 62, y: 450 },
  ...
  },
  {
    ...
    backgroundKey: "level-3-readable-lab",
    backgroundAmbience: { preset: "maintenance", intensity: 0.34, color: "#50ffc2", drift: 0.38, flicker: 0.14, particles: 0.28 },
    start: { x: 58, y: 450 },
  ...
  },
  {
    ...
    backgroundKey: "level-4-readable-lab",
    backgroundAmbience: { preset: "data", intensity: 0.4, color: "#bd5cff", drift: 0.44, flicker: 0.32, particles: 0.28 },
    start: { x: 56, y: 450 },
  ...
  },
  {
    ...
    backgroundKey: "level-5-readable-lab",
    backgroundAmbience: { preset: "maintenance", intensity: 0.32, color: "#6fd8ff", drift: 0.34, flicker: 0.16, particles: 0.24 },
    start: { x: 58, y: 450 },
    exit: r(3260, 438, 48, 62),
    bounds: bounds(3400),
    solids: [
  ...
  },
  {
    ...
    backgroundKey: "level-6-readable-lab",
    backgroundAmbience: { preset: "security", intensity: 0.42, color: "#ff4f6d", drift: 0.24, flicker: 0.52, particles: 0.16 },
    start: { x: 58, y: 450 },
  ...
  },
  {
    ...
    backgroundKey: "level-7-readable-lab",
    backgroundAmbience: { preset: "reactor", intensity: 0.38, color: "#ffe35a", drift: 0.22, flicker: 0.36, particles: 0.18 },
    start: { x: 54, y: 450 },
  ...
  },
  {
    ...
    backgroundKey: "level-8-readable-lab",
    backgroundAmbience: { preset: "maintenance", intensity: 0.38, color: "#50ffc2", drift: 0.48, flicker: 0.2, particles: 0.3 },
    start: { x: 56, y: 450 },
    ...
    cores: [{ id: "core-e", ...r(994, 466, 24, 24), label: "E", size: "large" }],
  ...
  },
  {
    ...
    backgroundKey: "level-9-readable-lab",
    backgroundAmbience: { preset: "data", intensity: 0.44, color: "#bd5cff", drift: 0.54, flicker: 0.34, particles: 0.34 },
    start: { x: 54, y: 450 },
    exit: r(4060, 438, 48, 62),
    bounds: bounds(4200),
    solids: [
    ...
    cores: [{ id: "core-f", ...r(876, 466, 24, 24), label: "F", size: "large" }],
  ...
  },
  {
    ...
    backgroundKey: "level-10-readable-lab",
    backgroundAmbience: { preset: "reactor", intensity: 0.46, color: "#ffe35a", drift: 0.24, flicker: 0.42, particles: 0.24 },
    start: { x: 52, y: 450 },
    ...
    cores: [{ id: "core-g", ...r(2320, 466, 24, 24), label: "G", size: "large" }],
